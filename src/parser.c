...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [20] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_context, 1),
  [22] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable, 3),
  [24] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variable, 4),
